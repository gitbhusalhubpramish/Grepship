	...
	return (
		<div className="bg-[#FFF8E7] h-screen w-screen pt-30 flex justify-center items-center">
			...
			<form className="text-[#6B8E3D] bg-[#FFFFFF] border-[#E4DFC9] border-2 min-w-15 min-h-102 p-5 w-1/5 h-2/3 rounded-3xl" onSubmit={handelSubmit}>
				...
				<label className=" w-full my-2">
                                        Password: <br/>
                                        <input name="password" type="password" className="border-[#a7e6a7] border-1 bg-[#e7ffe7]  rounded-lg mb-2 mt-1 w-full h-7" placeholder="Use strong password" value={form.password} onChange={(e)=>handelChange(e)} required/>
                                </label>
				<label className=" w-full my-2">
                                        Confirm Password: <br/>
                                        <input name="conformpass" type="password" className="border-[#a7e6a7] border-1 bg-[#e7ffe7]  rounded-lg mb-2 mt-1 w-full h-7" placeholder="Above Password" value={form.conformpass} onChange={(e)=>handelChange(e)} required/>
                                </label>
				<label className=" w-full my-2">
