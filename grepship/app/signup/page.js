export default function Signup(){
	return (
		<div className="bg-[#FFF8E7] h-screen w-screen pt-30 flex justify-center items-center">
			<div className="text-[#6B8E3D] bg-[#FFFFFF] border-[#E4DFC9] border-2 min-w-15 min-h-85 p-5 w-1/5 h-2/3 rounded-3xl">
				...
				<button className="w-full h-10 my-5">Join us</button>
			</div>
		</div>
	)
}
